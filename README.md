...
> Framework/SDK maintainers: This template includes setup guides, utilities, and a GitHub Action to help you and your community build and publish codemods easily.
> ## For one-time setup, see the doc [here](https://docs.codemod.com/oss).
